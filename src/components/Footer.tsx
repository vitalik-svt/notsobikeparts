...
export default function Footer({ locale }: { locale: string }) {
    ...
    return (
        <footer className="flex flex-col invert-1 bg-white rounded-t-xl md:flex-row gap-5 justify-between items-center max-w-[1000px] mx-auto w-full text-xl leading-tight px-5 pt-8 pb-10 md:py-7">
