    ...
    return (
        <li key={subitem.label}>
            {hasLink ? (
                ...
                <>
                    <button className="flex justify-between items-stretch w-full border-b md:border-0 relative before:absolute before:top-0 before:left-0 before:w-5 before:h-full before:bg-black before:content-['']">
